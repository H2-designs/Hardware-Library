# AAR update — mqtt-lib 2.5.0 + hardware-lib 7.20.0

## What to do (2 steps, no code changes)

1. Replace BOTH AARs in your app's `libs/`:
   - `mqtt-lib-2.5.0.aar` (replaces 2.2.0)
   - `hardware-lib-7.20.0.aar` (replace whatever version you bundle now)

   ```gradle
   implementation files('libs/mqtt-lib-2.5.0.aar')
   implementation files('libs/hardware-lib-7.20.0.aar')
...
| Send | Expect |
|---|---|
| `version` | `[remote] mqtt-lib 2.5.0, hardware-lib 7.20.0` |
