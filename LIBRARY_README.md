...
> gradle dependency (`project(':hardware-lib')` / `hardware-lib-7.20.0.aar`) and that MQTT
...
If consuming raw AARs instead: add `hardware-lib-7.20.0.aar`, `mqtt-lib-2.5.0.aar`, **and**
