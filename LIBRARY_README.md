...
| `HardwareLib.setDirectVend(Boolean)` / `isDirectVend` *(7.28.0)* | `setDirectVend:on` / `setDirectVend:off` | accept VEND REQUEST in any state for VMCs that skip the handshake (default off). Dashboard: **Direct Vend** toggle |
