...
> gradle dependency (`project(':hardware-lib')` / `hardware-lib-7.22.1.aar`) and that MQTT
...
If consuming raw AARs instead: add `hardware-lib-7.22.1.aar`, `mqtt-lib-2.5.2.aar`, **and**
